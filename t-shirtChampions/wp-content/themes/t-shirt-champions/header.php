	...
	<div id="header_wrap">
		<div id="header" class="container">
			<div id="header_content" class="col24 columns">
                ...
                <a id="mobile_logo" class="" href="/"><img src="<?php bloginfo('template_directory'); ?>/images/logo-mobile.png" alt="Tshirt Champions"></a>
                ...
                <ul id="nav">
                    ...
                    <a  href="http://design.tshirtchampions.com/tshirt_shop"><span
