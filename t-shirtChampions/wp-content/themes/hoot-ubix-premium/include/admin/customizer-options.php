...
function hoot_theme_customizer_options() {
	...
	$settings['header_layout_help'] = array(
		'section'     => $section,
		'type'        => 'content',
		'content'     => '<em>' . __( 'Select options below to create a variety of header layouts. Example:', 'hoot-ubix-premium' ) . '</em><br><img src="' . $imagepath . 'header-layout.png">',
	);

	$settings['primary_menuarea'] = array(
		'label'       => __( 'Primary Area (right of logo)', 'hoot-ubix-premium' ),
		'section'     => $section,
		'type'        => 'radio',
		'choices'     => array(
			'menu'        => __('Display Primary Menu', 'hoot-ubix-premium'),
	...
	$settings['secondary_menu_location'] = array(
		'label'       => __( 'Secondary Menu Location', 'hoot-ubix-premium' ),
		'section'     => $section,
		'type'        => 'radio',
		'choices'     => array(
			'top'        => __('Top (above logo)', 'hoot-ubix-premium'),
			'bottom'     => __('Bottom (below logo)', 'hoot-ubix-premium'),
			'none'       => __('Do not display secondary menu', 'hoot-ubix-premium'),
		),
		'default'     => 'bottom',
	);

	$settings['secondary_menu_align'] = array(
		'label'       => __( 'Secondary Menu Alignment', 'hoot-ubix-premium' ),
		'section'     => $section,
		'type'        => 'radio',
		'choices'     => array(
