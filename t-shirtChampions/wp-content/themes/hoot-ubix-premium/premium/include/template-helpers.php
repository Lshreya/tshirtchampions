 ...
 * @todo: Redundant
 */
remove_filter( 'loop_meta_display_title', 'hoot_hide_loop_meta_static_frontpage' );
...
// }
// add_filter( 'frontpage_sidebar', 'hoot_premium_frontpage_sidebar', 5 );
...
function hoot_premium_main_layout_extension( $sidebar ) {
	...
	elseif ( is_front_page() && !is_home() ) // static page set as frontpage
		$sidebar = apply_filters( 'frontpage_sidebar', 'none' );
...
add_filter( 'loop_meta_display_title', 'hoot_premium_loop_meta_display_title', 5 );
...
add_filter( 'wooloop_meta_display_title', 'hoot_premium_wooloop_meta_display_title', 5 );
...
add_filter( 'loop_meta_pre_title_content', 'hoot_premium_loop_meta_pre_title_content', 5, 3 );
...
add_filter( 'loop_meta_pre_title_content_stretch', 'hoot_premium_loop_meta_pre_title_content_stretch', 5, 3 );
...
add_filter( 'loop_meta_pre_title_content_post', 'hoot_premium_loop_meta_pre_title_content_post', 5, 3 );
