...
function hoot_premium_base_enqueue_scripts() {
	...
	if ( ( current_theme_supports( 'hoot-lightbox' ) && !hoot_get_mod('disable_lightbox') ) || current_theme_supports( 'light-gallery' ) ) {
...
function hoot_premium_localize_theme_script( $hootdata ) {
	...
	$hootdata['lightGallery'] = ( current_theme_supports( 'light-gallery' ) ) ? 'enable' : 'disable';
