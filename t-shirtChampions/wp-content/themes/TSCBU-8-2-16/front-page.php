        ...
        <?php 
          if(have_rows('slides')):
            while(have_rows('slides')):
              ...
              $checked    = get_sub_field('image_setting');
              $cover    = "background-size: cover;background-repeat: no-repeat;"
          ?>
          <div class="responsive-image" style="background-image:url(<?php echo $slide_background; ?>);<?php if($checked =="Cover")
                echo $cover; ?>">
            <div class="container">
...
<?php
$days_for_delivery_free_shipping = get_field('days_for_delivery_free_shipping');
$days_for_delivery_rush_shipping = get_field('days_for_delivery_rush_shipping');
?>
...
<?php
              echo date('M', strtotime('+ '. $days_for_delivery_free_shipping .' days'));
?>
        </div>
        <div class="day openb">
          <?php
              echo date('d', strtotime('+ '. $days_for_delivery_free_shipping .' days'));
          ?>
      </div>
      </div>
     <div class="rush">
      <div class="month openxb" >
                      <?php
              echo date('M', strtotime('+ '. $days_for_delivery_rush_shipping .' days'));
              ?>
      </div>
      <div class="day openb">
      <?php
$Date = "d";
echo date('d', strtotime(' + '. $days_for_delivery_rush_shipping .' days'));
?>
</div>
     </div>
    <div class="link">
...
<div class= "above-fold-content container">
  <?php $content = get_field( "above_fold_content" ); ?>
  <?php echo $content; ?>
</div>
...
<div id="triptych" class="container">
  <div id="edit-triptych" class="">
    <div class="row">
      ...
      ?>
      <div class="trip medium-4 columns last">
...
?>
      <a class="r_float" href="<?php echo site_url('/our-company/submit-a-testimonal/'); ?>">Submit a Review »</a>
      <a class="l_float" href="<?php echo site_url('/our-company/testimonials/'); ?>">More Reviews »</a>
      <div class="clear"></div>
      </div>
</div>
</div>
