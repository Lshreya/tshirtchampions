...
?>
   ...
   <!-- display testimonial on home page-->
	<h1 style="text-align:center">Testimonials</a></h1>
		<div style="text-align:center" class="testimonial-home-inner">
			<?php
			$args = array(
			...
			<a class="r_float" href="<?php echo site_url('/our-company-2/testimonials/submit-a-testimonial/'); ?>">Submit a Review »</a>
      		<a class="l_float" href="<?php echo site_url('/our-company-2/testimonials/'); ?>">More Reviews »</a><!-- END TESTIMONIALS  -->
    	</div>
</div><!-- .grid -->
