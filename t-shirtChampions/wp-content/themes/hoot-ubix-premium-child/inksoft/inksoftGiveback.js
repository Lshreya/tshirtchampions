$(document).ready(function(){
	...
	$(".header-topbar").after(
		...
		'			<a href="http://design.tshirtchampions.com/tshirt_shop/Account">My Account</a><span>&nbsp;|&nbsp;</span>' +
		'			<a class="cart" href="http://design.tshirtchampions.com/tshirt_shop/Cart">View Cart</a>' + 
		'			<div class="clear"></div>' + 
		'		</div>' + 
