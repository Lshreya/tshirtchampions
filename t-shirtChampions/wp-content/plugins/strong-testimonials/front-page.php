...
?>
   ...
   <!-- display testimonial on home page-->
	<h1 style="text-align:center">Testimonials</a></h1>
	...
	<div class="carousel-wrapper">
		...
		?>
		<div style="text-align:center" class="testimonial-home-inner item-<?php echo $counter; ?>">
			<?php the_content(); ?>
			<?php 
			...
			<?php endif; ?>
			<a class="arrow arrow-prev" href="#item-<?php echo ($counter == 1 ? $maxPosts : ($counter - 1)); ?>"></a>
			<a class="arrow arrow-next" href="#item-<?php echo ($counter == $maxPosts ? "1" : ($counter + 1)); ?>"></a>
		</div>
		<?php 
					$counter = $counter + 1;
				}
		...
		<a class="l_float" href="<?php echo site_url('/our-company/testimonials/'); ?>">More Reviews »</a><!-- END TESTIMONIALS  -->
	</div>
