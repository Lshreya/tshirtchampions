$(document).ready(function(){
	...
	$(".header-topbar").after(
		...
		'			<a href="http://design.tshirtchampions.com/tshirtchampions/Account">My Account</a><span>&nbsp;|&nbsp;</span>' +
		'			<a class="cart" href="http://design.tshirtchampions.com/tshirtchampions/Cart">View Cart</a>' + 
		'			<div class="clear"></div>' + 
		'		</div>' + 
        ...
        '            <a href="https://www.tshirtchampions.com/design-library"><span class="robotb">Design</span><br><span class="bebas">Library</span></a>' +
        '            </li>' +
        '            <li id="wp_nav_faqs">' +
        ...
        '            <a href="http://design.tshirtchampions.com/tshirt_shop"><span class="robotb">T-Shirt</span><br><span class="bebas">Shop</span></a>' +
        '            </li>' +
        '        </ul>' +
		'	</div>' + 
        '</div>' +
